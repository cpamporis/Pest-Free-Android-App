          ...
          {todayAppointments.length === 0 ? (
            ...
            <View style={styles.appointmentsContainer}>
              {todayAppointments.map((appointment, index) => {
                ...
                const serviceType =
                  resolveAppointmentServiceType(appointment);
                        ...
                        {loadingAppointmentId !== appointment.id && (
                          <View style={styles.serviceTypeBadge}>
                            ...
                            <Text style={styles.serviceTypeText}>
                              {serviceType === "myocide"
                                ? i18n.t(
                                    "technician.home.appointments.serviceType.myocide"
                                  )
                                : serviceType === "disinfection"
                                ? i18n.t(
                                    "technician.home.appointments.serviceType.disinfection"
                                  )
                                : serviceType === "insecticide"
                                ? i18n.t(
                                    "technician.home.appointments.serviceType.insecticide"
                                  )
                                : serviceType === "certificate"
                                ? getCertificateServiceLabel()
                                : i18n.t(
                                    "technician.home.appointments.serviceType.special"
                                  )}
                            </Text>
                          </View>
                        )}
